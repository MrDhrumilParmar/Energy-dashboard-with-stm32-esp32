...
import {
    ...
    af as clearCanvas,
    ag as setsEqual,
    ah as getDatasetClipArea,
    ai as _elementsEqual,
    aj as _isClickEvent,
    ak as _isBetween,
    al as _normalizeAngle,
    am as _readValueToProps,
    an as _updateBezierControlPoints,
    ao as _computeSegments,
    ap as _boundSegments,
    aq as _steppedInterpolation,
    ar as _bezierInterpolation,
    as as _pointInLine,
    at as _steppedLineTo,
    au as _bezierCurveTo,
    av as drawPoint,
    aw as addRoundedRectPath,
    ax as toTRBL,
    ay as toTRBLCorners,
    az as _boundSegment,
    aA as getRtlAdapter,
    ...
    aN as log10,
    aO as _longestText,
    aP as _filterBetween,
    aQ as _lookup,
} from "./chunks/helpers.dataset.js";
import "@kurkle/color";
class Animator {
    constructor() {
        (this._request = null),
    ...
    _update(t = Date.now()) {
        ...
        this._charts.forEach((i, s) => {
            ...
            for (; o >= 0; --o)
                (n = a[o]),
                    n._active
                        ? (n._total > i.duration && (i.duration = n._total),
                          n.tick(t),
                          (r = !0))
...
const transparent = "transparent",
    interpolators = {
        ...
        color(t, e, i) {
            const s = color(t || transparent),
                a = s.valid && color(e || transparent);
...
class Animation {
    constructor(t, e, i, s) {
        ...
        (this._active = !0),
            (this._fn = t.fn || interpolators[t.type || typeof n]),
    ...
    update(t, e, i) {
        if (this._active) {
            ...
            (this._start = i),
                ...
                (this._total += a),
                (this._loop = !!t.loop),
                (this._to = resolve([t.to, e, s, t.from])),
                (this._from = resolve([t.from, s, e]));
        }
    }
    cancel() {
        this._active &&
    ...
    tick(t) {
        const e = t - this._start,
            ...
            o = this._to;
        let r;
        if (((this._active = a !== o && (n || e < i)), !this._active))
...
class Animations {
    ...
    _createAnimations(t, e) {
        ...
        for (r = n.length - 1; r >= 0; --r) {
            ...
            d && d.duration
                ? ((a[l] = c = new Animation(d, t, l, h)), s.push(c))
                : (t[l] = h);
        }
        return s;
    }
...
function updateStacks(t, e) {
    ...
    for (let t = 0; t < d; ++t) {
        const i = e[t],
            { [l]: n, [h]: d } = i;
        (u = (i._stacks || (i._stacks = {}))[h] = getOrCreateStack(a, c, n)),
            (u[r] = d),
            (u._top = getLastIndexInStack(u, o, !0, s.type)),
            (u._bottom = getLastIndexInStack(u, o, !1, s.type));
...
class DatasetController {
    ...
    linkScales() {
        const t = this.chart,
            ...
            a = (e.xAxisID = valueOrDefault(
                i.xAxisID,
                getFirstScaleId(t, "x")
            )),
            n = (e.yAxisID = valueOrDefault(
                i.yAxisID,
                getFirstScaleId(t, "y")
            )),
            o = (e.rAxisID = valueOrDefault(
                i.rAxisID,
                getFirstScaleId(t, "r")
            )),
            r = e.indexAxis,
    ...
    updateRangeFromParsed(t, e, i, s) {
        ...
        s &&
            o &&
            ((s.values = o), (n = applyStack(s, a, this._cachedMeta.index))),
    ...
    getMinMax(t, e) {
        const i = this._cachedMeta,
            ...
            r = createStack(e, i, this.chart),
            l = {
                min: Number.POSITIVE_INFINITY,
                max: Number.NEGATIVE_INFINITY,
            },
            { min: h, max: c } = getUserBounds(o);
        let d, u;
        function g() {
            u = s[d];
            const e = u[o.axis];
        ...
        for (
            d = 0;
            d < n && (g() || (this.updateRangeFromParsed(l, t, u, r), !a));
            ++d
        );
        if (a)
            for (d = n - 1; d >= 0; --d)
    ...
    getAllParsedValues(t) {
        ...
        for (s = 0, a = e.length; s < a; ++s)
            (n = e[s][t.axis]), isNumberFinite(n) && i.push(n);
        return i;
    }
    getMaxOverflow() {
        return !1;
    ...
    getContext(t, e, i) {
        ...
        if (t >= 0 && t < this._cachedMeta.data.length) {
            ...
            (a =
                e.$context ||
                (e.$context = createDataContext(this.getContext(), t, e))),
    ...
    _resolveElementOptions(t, e = "default", i) {
        ...
        const l = this.chart.config,
            ...
            u = Object.keys(defaults.elements[t]),
            g = l.resolveNamedOptions(d, u, () => this.getContext(i, s, e), c);
        return (
            g.$shared &&
                ((g.$shared = r),
                (a[n] = Object.freeze(cloneIfNotShared(g, r)))),
            g
        );
    }
...
function computeMinSampleSize(t) {
    ...
    const l = () => {
        32767 !== n &&
            -32768 !== n &&
            (defined(o) && (r = Math.min(r, Math.abs(n - o) || r)), (o = n));
    };
...
function computeFitCategoryTraits(t, e, i, s) {
    ...
    return (
        isNullOrUndef(a)
            ? ((n = e.min * i.categoryPercentage), (o = i.barPercentage))
            : ((n = a * s), (o = 1)),
...
function parseFloatBar(t, e, i, s) {
    const a = i.parse(t[0], s),
        n = i.parse(t[1], s),
        o = Math.min(a, n),
        r = Math.max(a, n);
    let l = o,
        h = r;
    Math.abs(o) > Math.abs(r) && ((l = r), (h = o)),
        (e[i.axis] = h),
        (e._custom = {
            barStart: l,
            barEnd: h,
...
function parseValue(t, e, i, s) {
    return (
        isArray(t) ? parseFloatBar(t, e, i, s) : (e[i.axis] = i.parse(t, s)), e
    );
}
...
function setBorderSkipped(t, e, i, s) {
    ...
    "middle" === a &&
        ...
        (i._top || 0) === s
            ...
            : (i._bottom || 0) === s
            ? (a = c)
            : ((n[parseEdge(c, o, r, l)] = !0), (a = h))),
        (n[parseEdge(a, o, r, l)] = !0),
        (t.borderSkipped = n);
}
...
class BarController extends DatasetController {
    ...
    parseObjectData(t, e, i, s) {
        ...
        for (d = i, u = i + s; d < u; ++d)
            (p = e[d]),
                (g = {}),
                (g[a.axis] = a.parse(resolveObjectKey(p, l), d)),
                c.push(parseValue(resolveObjectKey(p, h), g, n, d));
        return c;
    }
    updateRangeFromParsed(t, e, i, s) {
    ...
    updateElements(t, e, i, s) {
        ...
        for (let u = e; u < e + i; u++) {
            const e = this.getParsed(u),
                i =
                    a || isNullOrUndef(e[o.axis])
                        ? { base: r, head: r }
                        : this._calculateBarValuePixels(u),
                g = this._calculateBarIndexPixels(u, h),
                p = (e._stacks || {})[o.axis],
                f = {
                    horizontal: l,
                    base: i.base,
            ...
            setBorderSkipped(f, m, p, n),
                setInflateAmount(f, m, h.ratio),
                this.updateElement(t[u], u, f, s);
        }
    }
    _getStacks(t, e) {
    ...
    _calculateBarValuePixels(t) {
        ...
        if (
            ...
            const t = e.getPixelForDecimal(0),
                a = e.getPixelForDecimal(1),
                l = Math.min(t, a),
                g = Math.max(t, a);
            (m = Math.max(Math.min(m, g), l)),
                (c = m + d),
                i &&
                    !h &&
    ...
    _calculateBarIndexPixels(t, e) {
        const i = e.scale,
            s = this.options,
            a = s.skipNull,
            n = valueOrDefault(s.maxBarThickness, 1 / 0);
        let o, r;
        ...
        if (e.grouped) {
            const i = a ? this._getStackCount(t) : e.stackCount,
                h =
                    "flex" === s.barThickness
                        ? computeFlexCategoryTraits(t, e, s, i * l)
                        : computeFitCategoryTraits(t, e, s, i * l),
                c =
                    "x" === this.chart.options.indexAxis
                        ? this.getDataset().xAxisID
                        : this.getDataset().yAxisID,
                d = this._getAxis().indexOf(
                    valueOrDefault(c, this.getFirstScaleIdForIndexAxis())
                ),
                u =
                    this._getStackIndex(
                        this.index,
            ...
            (o = h.start + h.chunk * u + h.chunk / 2),
                (r = Math.min(n, h.chunk * h.ratio));
        } else
...
class BubbleController extends DatasetController {
    ...
    updateElements(t, e, i, s) {
        const a = "reset" === s,
            { iScale: n, vScale: o } = this._cachedMeta,
    ...
    resolveDataElementOptions(t, e) {
        ...
        return (
            "active" !== e && (s.radius = 0),
            (s.radius += valueOrDefault(i && i._custom, a)),
            s
        );
    }
}
function getRatioAndOffset(t, e, i) {
    ...
    if (e < TAU) {
        const r = t,
            ...
            u = Math.sin(l),
            g = (t, e, s) =>
                _angleBetween(t, r, l, !0) ? 1 : Math.max(e, e * i, s, s * i),
            p = (t, e, s) =>
                _angleBetween(t, r, l, !0) ? -1 : Math.min(e, e * i, s, s * i),
            f = g(0, h, d),
            m = g(HALF_PI, c, u),
            x = p(PI, h, d),
            b = p(PI + HALF_PI, c, u);
...
class DoughnutController extends DatasetController {
    ...
    update(t) {
        const e = this.chart,
            ...
            r = Math.min(toPercentage(this.options.cutout, o), 1),
    ...
    _circumference(t, e) {
        ...
        return (e && i.animation.animateRotate) ||
            ...
            s.data[t].hidden
            ? 0
            : this.calculateCircumference((s._parsed[t] * a) / TAU);
    }
    updateElements(t, e, i, s) {
        const a = "reset" === s,
            n = this.chart,
        ...
        for (f = e; f < e + i; ++f) {
            const e = this._circumference(f, a),
                i = t[f],
                n = {
                    x: l + this.offsetX,
                    y: h + this.offsetY,
    ...
    _getRingWeight(t) {
        return Math.max(
            valueOrDefault(this.chart.data.datasets[t].weight, 1),
            0
        );
    }
...
class LineController extends DatasetController {
    ...
    update(t) {
        ...
        (this._drawStart = o),
            (this._drawCount = r),
            _scaleRangesChanged(e) && ((o = 0), (r = s.length)),
            (i._chart = this.chart),
    ...
    updateElements(t, e, i, s) {
        ...
        for (let i = 0; i < b; ++i) {
            ...
            const y = this.getParsed(i),
                v = isNullOrUndef(y[u]),
                k = (b[d] = n.getPixelForValue(y[d], i)),
                S = (b[u] =
                    a || v
                        ? o.getBasePixel()
                        : o.getPixelForValue(
                              r ? this.applyStack(o, y, r) : y[u],
                              i
                          ));
            (b.skip = isNaN(k) || isNaN(S) || v),
                (b.stop = i > 0 && Math.abs(y[d] - _[d]) > f),
                p && ((b.parsed = y), (b.raw = l.data[i])),
                c &&
                    (b.options =
                        h ||
                        this.resolveDataElementOptions(
    ...
    updateElements(t, e, i, s) {
        ...
        for (d = e; d < e + i; d++) {
            ...
            let i = u,
                ...
                f = n.getDataVisibility(d)
                    ? r.getDistanceFromCenterForValue(this.getParsed(d).r)
                    : 0;
            (u = p),
                a &&
                    (o.animateScale && (f = 0), o.animateRotate && (i = p = c));
            const m = {
                x: l,
                y: h,
                innerRadius: 0,
    ...
    updateElements(t, e, i, s) {
        ...
        for (let o = e; o < e + i; o++) {
            const e = t[o],
                ...
                r = a.getPointPositionForValue(o, this.getParsed(o).r),
                l = n ? a.xCenter : r.x,
                h = n ? a.yCenter : r.y,
                c = {
                    x: l,
...
class ScatterController extends DatasetController {
    ...
    update(t) {
        ...
        if (
            ((this._drawStart = a),
            (this._drawCount = n),
            _scaleRangesChanged(e) && ((a = 0), (n = i.length)),
    ...
    updateElements(t, e, i, s) {
        const a = "reset" === s,
            ...
            x = this.chart._animationsDisabled || a || "none" === s;
            ...
            const e = t[h],
                ...
                v = (p[g] =
                    a || _
                        ? o.getBasePixel()
                        : o.getPixelForValue(
                              r ? this.applyStack(o, i, r) : i[g],
                              h
                          ));
            (p.skip = isNaN(y) || isNaN(v) || _),
                (p.stop = h > 0 && Math.abs(i[u] - b[u]) > m),
                f && ((p.parsed = i), (p.raw = l.data[h])),
                d &&
                    (p.options =
                        c ||
                        this.resolveDataElementOptions(
...
function binarySearch(t, e, i, s) {
    ...
    if (r && e === r.axis && "r" !== e && o && n.length) {
        ...
        if (!s) {
            const s = o(n, e, i);
            if (l) {
                const { vScale: e } = a._cachedMeta,
                    { _parsed: i } = t,
                    n = i
                        .slice(0, s.lo + 1)
                        .reverse()
                        .findIndex((t) => !isNullOrUndef(t[e.axis]));
                s.lo -= Math.max(0, n);
                const o = i
                    .slice(s.hi)
                    .findIndex((t) => !isNullOrUndef(t[e.axis]));
...
function evaluateInteractionItems(t, e, i, s, a) {
    ...
    for (let t = 0, i = n.length; t < i; ++t) {
        const { index: i, data: r } = n[t],
            { lo: l, hi: h } = binarySearch(n[t], e, o, a);
        for (let t = l; t <= h; ++t) {
            const e = r[t];
            e.skip || s(e, i, t);
        }
...
function getIntersectItems(t, e, i, s, a) {
    ...
    return (
        evaluateInteractionItems(
            ...
            e,
            function (i, o, r) {
                (a || _isPointInArea(i, t.chartArea, 0)) &&
                    i.inRange(e.x, e.y, s) &&
                    n.push({ element: i, datasetIndex: o, index: r });
            },
            !0
        ),
        n
...
function getNearestRadialItems(t, e, i, s) {
    let a = [];
    return (
        evaluateInteractionItems(t, i, e, function (t, i, n) {
            const { startAngle: o, endAngle: r } = t.getProps(
                    ["startAngle", "endAngle"],
                    s
                ),
                { angle: l } = getAngleFromPoint(t, { x: e.x, y: e.y });
            _angleBetween(l, o, r) &&
                a.push({ element: t, datasetIndex: i, index: n });
        }),
        a
    );
}
function getNearestCartesianItems(t, e, i, s, a, n) {
    ...
    return (
        evaluateInteractionItems(t, i, e, function (i, h, c) {
            ...
            const g = r(e, u);
            g < l
                ? ((o = [{ element: i, datasetIndex: h, index: c }]), (l = g))
                : g === l && o.push({ element: i, datasetIndex: h, index: c });
        }),
        o
    );
}
...
function getAxisItems(t, e, i, s, a) {
    ...
    let r = !1;
    return (
        evaluateInteractionItems(t, i, e, (t, s, l) => {
            t[o] &&
                t[o](e[i], a) &&
                (n.push({ element: t, datasetIndex: s, index: l }),
                (r = r || t.inRange(e.x, e.y, a)));
        }),
        s && !r ? [] : n
    );
}
var Interaction = {
    ...
    modes: {
        index(t, e, i, s) {
            const a = getRelativePosition(e, t),
                n = i.axis || "x",
                o = i.includeInvisible || !1,
                r = i.intersect
                    ? getIntersectItems(t, a, n, s, o)
                    : getNearestItems(t, a, n, !1, s, o),
                l = [];
            return r.length
        ...
        x: (t, e, i, s) =>
            getAxisItems(t, getRelativePosition(e, t), "x", i.intersect, s),
        y: (t, e, i, s) =>
            getAxisItems(t, getRelativePosition(e, t), "y", i.intersect, s),
    },
};
...
function setLayoutDims(t, e) {
    ...
    for (n = 0, o = t.length; n < o; ++n) {
        ...
        r.horizontal
            ? ((r.width = h ? h * s : o && e.availableWidth), (r.height = a))
            : ((r.width = s), (r.height = h ? h * a : o && e.availableHeight));
    }
    return i;
}
function buildLayoutBoxes(t) {
    const e = wrapBoxes(t),
        ...
        o = sortByWeight(filterByPosition(e, "bottom")),
...
function updateDims(t, e, i, s) {
    ...
    const r = Math.max(0, e.outerWidth - getCombinedMax(o, t, "left", "right")),
        l = Math.max(0, e.outerHeight - getCombinedMax(o, t, "top", "bottom")),
        h = r !== t.w,
        c = l !== t.h;
    return (
        (t.w = r),
...
function placeBoxes(t, e, i, s) {
    ...
    for (const r of t) {
        ...
        if (r.horizontal) {
            const s = e.w * h,
                n = l.size || t.height;
            defined(l.start) && (o = l.start),
                t.fullSize
                    ? setBoxDims(
                          t,
                          a.left,
                          o,
                          i.outerWidth - a.right - a.left,
                          n
                      )
                    : setBoxDims(t, e.left + l.placed, o, s, n),
                (l.start = o),
                (l.placed += s),
                (o = t.bottom);
        } else {
            ...
            defined(l.start) && (n = l.start),
                t.fullSize
                    ? setBoxDims(
                          ...
                          a.top,
                          o,
                          i.outerHeight - a.bottom - a.top
                      )
                    : setBoxDims(t, n, e.top + l.placed, o, s),
                (l.start = n),
                (l.placed += s),
                (n = t.right);
        }
...
var layouts = {
    ...
    update(t, e, i, s) {
        if (!t) return;
        const a = toPadding(t.options.layout.padding),
        ...
        const g = Object.assign(
                { maxPadding: u, w: n, h: o, x: a.left, y: a.top },
                a
            ),
            p = setLayoutDims(l.concat(h), d);
        fitBoxes(r.fullSize, g, d, p),
            fitBoxes(l, g, d, p),
            fitBoxes(h, g, d, p) && fitBoxes(l, g, d, p),
            handleMaxPadding(g),
            placeBoxes(r.leftAndTop, g, d, p),
            (g.x += g.w),
            (g.y += g.h),
            placeBoxes(r.rightAndBottom, g, d, p),
            (t.chartArea = {
                left: g.left,
                top: g.top,
                right: g.left + g.w,
...
function fromNativeEvent(t, e) {
    const i = EVENT_TYPES[t.type] || t.type,
        { x: s, y: a } = getRelativePosition(t, e);
    return {
        type: i,
        chart: e,
        native: t,
...
function onWindowResize() {
    ...
    t !== oldDevicePixelRatio &&
        ((oldDevicePixelRatio = t),
        drpListeningCharts.forEach((e, i) => {
...
function autoSkip(t, e) {
    const i = t.options.ticks,
        s = determineMaxTicks(t),
        a = Math.min(i.maxTicksLimit || s, s),
        n = i.major.enabled ? getMajorIndices(e) : [],
        o = n.length,
        r = n[0],
        l = n[o - 1],
        h = [];
    ...
    if (o > 0) {
        ...
        for (
            skip(e, h, c, isNullOrUndef(s) ? 0 : r - s, r), t = 0, i = o - 1;
            t < i;
            t++
        )
            skip(e, h, c, n[t], n[t + 1]);
...
function skipMajors(t, e, i, s) {
    ...
    for (s = Math.ceil(s), a = 0; a < t.length; a++)
        a === o && (e.push(t[a]), n++, (o = i[n * s]));
}
function skip(t, e, i, s, a) {
    const n = valueOrDefault(s, 0),
        o = Math.min(valueOrDefault(a, t.length), t.length);
    let r,
        l,
        h,
        c = 0;
...
function getTitleHeight(t, e) {
    ...
    const i = toFont(t.font, e),
        s = toPadding(t.padding);
...
class Scale extends Element {
    ...
    getUserBounds() {
        ...
        return (
            ...
            (s = finiteOrDefault(s, Number.NEGATIVE_INFINITY)),
            {
    ...
    getMinMax(t) {
        ...
        for (let r = 0, l = o.length; r < l; ++r)
            (e = o[r].controller.getMinMax(this, t)),
    ...
    update(t, e, i) {
        const { beginAtZero: s, grace: a, ticks: n } = this.options,
            o = n.sampleSize;
        this.beforeUpdate(),
            (this.maxWidth = t),
            (this.maxHeight = e),
            ...
            this._dataLimitsCached ||
                ...
                (this._range = _addGrace(this, a, s)),
                (this._dataLimitsCached = !0)),
            this.beforeBuildTicks(),
            (this.ticks = this.buildTicks() || []),
            this.afterBuildTicks();
        const r = o < this.ticks.length;
        this._convertTicksToLabels(r ? sample(this.ticks, o) : this.ticks),
            this.configure(),
    ...
    generateTickLabels(t) {
        ...
        let i, s, a;
        for (i = 0, s = t.length; i < s; i++)
            (a = t[i]), (a.label = callback(e.callback, [a.value, i, t], this));
    }
    ...
    calculateLabelRotation() {
        const t = this.options,
            e = t.ticks,
            i = getTicksLimit(this.ticks.length, t.ticks.maxTicksLimit),
            s = e.minRotation || 0,
            a = e.maxRotation;
        let n,
            o,
        ...
        (n = t.offset ? this.maxWidth / i : u / (i - 1)),
            c + 6 > n &&
                ((n = u / (i - (t.offset ? 0.5 : 1))),
                (o =
                    this.maxHeight -
                    getTickMarkLength(t.grid) -
                    e.padding -
                    getTitleHeight(t.title, this.chart.options.font)),
                (r = Math.sqrt(c * c + d * d)),
                (l = toDegrees(
                    Math.min(
                        Math.asin(
                            _limitValue((h.highest.height + 6) / n, -1, 1)
                        ),
                        Math.asin(_limitValue(o / r, -1, 1)) -
                            Math.asin(_limitValue(d / r, -1, 1))
                    )
                )),
            ...
            if (
                (o
                    ? ((t.width = this.maxWidth),
                      (t.height = getTickMarkLength(a) + n))
                    : ((t.height = this.maxHeight),
                      (t.width = getTickMarkLength(a) + n)),
    ...
    _computeLabelSizes(t, e, i) {
        const { ctx: s, _longestTextCache: a } = this,
            n = [],
            o = [],
            r = Math.floor(e / getTicksLimit(e, i));
        let l,
            h,
            c,
            d,
                ...
                if (isArray(d))
                    for (h = 0, c = d.length; h < c; ++h)
                        (b = d[h]),
                            isNullOrUndef(b) ||
                                isArray(b) ||
                                ((m = _measureText(s, p.data, p.gc, m, b)),
                                (x += f));
    ...
    getPixelForDecimal(t) {
        ...
        return _int16Range(
            this._alignToPixels ? _alignPixel(this.chart, e, 0) : e
        );
    }
    ...
    _tickSize() {
        const t = this.options.ticks,
            ...
            o = a ? a.widest.width + n : 0,
            r = a ? a.highest.height + n : 0;
    ...
    _computeGridLineItems(t) {
        const e = this.axis,
            i = this.chart,
            s = this.options,
            { grid: a, position: n, border: o } = s,
            r = a.offset,
            l = this.isHorizontal(),
            h = this.ticks.length + (r ? 1 : 0),
            c = getTickMarkLength(a),
            d = [],
            u = o.setContext(this.getContext()),
            g = u.display ? u.width : 0,
            p = g / 2,
            f = function (t) {
                return _alignPixel(i, t, g);
            };
        let m, x, b, _, y, v, k, S, D, M, P, A;
        if ("top" === n)
            (m = f(this.bottom)),
                (v = this.bottom - c),
                (S = m - p),
            ...
            if ("center" === n) m = f((t.top + t.bottom) / 2 + 0.5);
            else if (isObject(n)) {
                const t = Object.keys(n)[0],
                    e = n[t];
                m = f(this.chart.scales[t].getPixelForValue(e));
            }
            (M = t.top), (A = t.bottom), (v = m + p), (S = v + c);
        } else if ("y" === e) {
            if ("center" === n) m = f((t.left + t.right) / 2);
            else if (isObject(n)) {
                const t = Object.keys(n)[0],
                    e = n[t];
                m = f(this.chart.scales[t].getPixelForValue(e));
        ...
        const C = valueOrDefault(s.ticks.maxTicksLimit, h),
            w = Math.max(1, Math.ceil(h / C));
        for (x = 0; x < h; x += w) {
            ...
            (b = getPixelForGridLine(this, x, r)),
                void 0 !== b &&
                    ((_ = _alignPixel(i, b, n)),
                    l ? (y = k = D = P = _) : (v = S = M = A = _),
                    d.push({
                        tx1: y,
                        ty1: v,
                        tx2: k,
    ...
    _computeLabelItems(t) {
        const e = this.axis,
            ...
            n = this.isHorizontal(),
            o = this.ticks,
            { align: r, crossAlign: l, padding: h, mirror: c } = a,
            d = getTickMarkLength(i.grid),
            u = d + h,
            g = c ? -h : u,
            p = -toRadians(this.labelRotation),
            f = [];
        let m,
            x,
            b,
        ...
        for (m = 0, x = o.length; m < x; ++m) {
            ...
            (S = this.getPixelForTick(m) + a.labelOffset),
                (D = this._resolveTickFontOptions(m)),
                (M = D.lineHeight),
                (P = isArray(_) ? _.length : 1);
            const e = P / 2,
                i = t.color,
                r = t.textStrokeColor,
                h = t.textStrokeWidth;
            ...
            if (
                      ...
                      (A =
                          "top" === s
                              ? "near" === l || 0 !== p
                                  ? -P * M + M / 2
                                  : "center" === l
                                  ? -w.highest.height / 2 - e * M + M
                                  : -w.highest.height + M / 2
                              : "near" === l || 0 !== p
                              ? M / 2
                              : "center" === l
                              ? w.highest.height / 2 - e * M
                              : w.highest.height - P * M),
                      c && (A *= -1),
                      0 === p ||
                          t.showLabelBackdrop ||
                          (y += (M / 2) * Math.sin(p)))
                ...
                const e = toPadding(t.backdropPadding),
                    i = w.heights[m],
                    s = w.widths[m];
                let a = A - e.top,
                    n = 0 - e.left;
    ...
    drawBorder() {
        ...
        let l, h, c, d;
        this.isHorizontal()
            ? ((l = _alignPixel(t, this.left, n) - n / 2),
              (h = _alignPixel(t, this.right, o) + o / 2),
              (c = d = r))
            : ((c = _alignPixel(t, this.top, n) - n / 2),
              (d = _alignPixel(t, this.bottom, o) + o / 2),
              (l = h = r)),
            e.save(),
            (e.lineWidth = a.width),
    ...
    drawTitle() {
        ...
        if (!i.display) return;
        const a = toFont(i.font),
            n = toPadding(i.padding),
            o = i.align;
        let r = a.lineHeight / 2;
        "bottom" === e || "center" === e || isObject(e)
            ? ((r += n.bottom),
              isArray(i.text) && (r += a.lineHeight * (i.text.length - 1)))
            : (r += n.top);
        const {
            titleX: l,
            titleY: h,
...
class TypedRegistry {
    ...
    unregister(t) {
        ...
        i in e && delete e[i],
            s &&
                i in defaults[s] &&
                (delete defaults[s][i], this.override && delete overrides[i]);
    }
}
function registerDefaults(t, e, i) {
    const s = merge(Object.create(null), [
        i ? defaults.get(i) : {},
        defaults.get(e),
        t.defaults,
    ]);
...
class Registry {
    ...
    _exec(t, e, i) {
        ...
        callback(i["before" + s], [], i),
            e[t](i),
            callback(i["after" + s], [], i);
    }
...
class PluginService {
    ...
    _createDescriptors(t, e) {
        const i = t && t.config,
            s = valueOrDefault(i.options && i.options.plugins, {}),
            a = allPlugins(i);
...
function allPlugins(t) {
    const e = {},
        i = [],
        s = Object.keys(registry.plugins.items);
...
function createDescriptors(t, { plugins: e, localIds: i }, s, a) {
    ...
    for (const r of e) {
        ...
        null !== l &&
            n.push({
                plugin: r,
                options: pluginOpts(t.config, { plugin: r, local: i[e] }, l, o),
            });
    }
    return n;
}
...
function mergeScaleConfig(t, e) {
    const i = overrides[t.type] || { scales: {} },
        s = e.scales || {},
        a = getIndexAxis(t.type, e),
    ...
    return (
        Object.keys(s).forEach((e) => {
            ...
            const r = determineAxis(
                    e,
                    o,
                    retrieveAxisFromDatasets(e, t),
                    defaults.scales[o.type]
                ),
                l = getDefaultScaleIDFromAxis(r, a),
                h = i.scales || {};
            n[e] = mergeIf(Object.create(null), [{ axis: r }, o, h[r], h[l]]);
        }),
        t.data.datasets.forEach((i) => {
            const a = i.type || t.type,
                o = i.indexAxis || getIndexAxis(a, e),
                r = (overrides[a] || {}).scales || {};
            Object.keys(r).forEach((t) => {
                const e = getAxisFromDefaultScaleID(t, o),
                    a = i[e + "AxisID"] || e;
                (n[a] = n[a] || Object.create(null)),
                    mergeIf(n[a], [{ axis: e }, s[a], r[t]]);
            });
        }),
...
class Config {
    ...
    getOptionScopes(t, e, i) {
        ...
        const r = new Set();
        e.forEach((e) => {
            t && (r.add(t), e.forEach((e) => addIfFound(r, t, e))),
                e.forEach((t) => addIfFound(r, s, t)),
                e.forEach((t) => addIfFound(r, overrides[a] || {}, t)),
                e.forEach((t) => addIfFound(r, defaults, t)),
                e.forEach((t) => addIfFound(r, descriptors, t));
        });
        const l = Array.from(r);
        return (
            0 === l.length && l.push(Object.create(null)),
            keysCached.has(e) && n.set(e, l),
            l
        );
    }
    chartOptionScopes() {
    ...
    resolveNamedOptions(t, e, i, s = [""]) {
        const a = { $shared: !0 },
            { resolver: n, subPrefixes: o } = getResolver(
                this._resolverCache,
                t,
                s
            );
...
const hasFunction = (t) =>
    isObject(t) && Object.getOwnPropertyNames(t).some((e) => isFunction(t[e]));
function needContext(t, e) {
    ...
    for (const a of e) {
        const e = i(a),
            n = s(a),
            o = (n || e) && t[a];
        if ((e && (isFunction(o) || hasFunction(o))) || (n && isArray(o)))
            return !0;
    }
    return !1;
}
...
class Chart {
    ...
    constructor(t, e) {
        ...
        (this.platform = new (i.platform || _detectPlatform(s))()),
            this.platform.updateConfig(i);
        const o = this.platform.acquireContext(s, n.aspectRatio),
            r = o && o.canvas,
            l = r && r.height,
            h = r && r.width;
        (this.id = uid()),
    ...
    _resize(t, e) {
        ...
        (this.width = n.width),
            ...
            (this._aspectRatio = this.aspectRatio),
            retinaScale(this, o, !0) &&
                (this.notifyPlugins("resize", { size: n }),
                callback(i.onResize, [this, n], this),
        ...
        e &&
            ...
            each(a, (e) => {
                const a = e.options,
                    n = a.id,
                    o = determineAxis(n, a),
                    r = valueOrDefault(a.type, e.dtype);
                (void 0 !== a.position &&
                    positionIsHorizontal(a.position, o) ===
                        positionIsHorizontal(e.dposition)) ||
                    (a.position = e.dposition),
                    (s[n] = !0);
                let l = null;
                if (n in i && i[n].type === r) l = i[n];
                else {
                    (l = new (registry.getScale(r))({
                        id: n,
                        type: r,
                        ctx: this.ctx,
                        chart: this,
    ...
    buildOrUpdateControllers() {
        ...
        for (
            ...
            if (
                ...
                (a.type = n),
                (a.indexAxis = s.indexAxis || getIndexAxis(n, this.options)),
                (a.order = s.order || 0),
                (a.index = i),
                (a.label = "" + s.label),
                ...
                const e = registry.getController(n),
                    { datasetElementType: s, dataElementType: o } =
                        defaults.datasets[n];
                Object.assign(e, {
                    dataElementType: registry.getElement(o),
                    datasetElementType: s && registry.getElement(s),
                }),
                    (a.controller = new e(this, i)),
                    t.push(a.controller);
            }
        }
    ...
    _updateDatasets(t) {
        if (
            ...
            for (let e = 0, i = this.data.datasets.length; e < i; ++e)
                this._updateDataset(
                    e,
                    isFunction(t) ? t({ datasetIndex: e }) : t
                );
    ...
    _handleEvent(t, e, i) {
        const { _active: s = [], options: a } = this,
            ...
            r = _isClickEvent(t),
            l = determineLastEvent(t, this._lastEvent, i, r);
        i &&
            ((this._lastEvent = null),
            callback(a.onHover, [t, o, this], this),
            r && callback(a.onClick, [t, o, this], this));
        const h = !_elementsEqual(o, s);
        return (
            (h || e) && ((this._active = o), this._updateHoverStyles(o, s, e)),
            (this._lastEvent = l),
            h
        );
    }
...
function clipSelf(t, e, i) {
    const {
        ...
        d = Math.min(h / o, _normalizeAngle(s - i));
    if ((t.beginPath(), t.arc(a, n, o - h / 2, s + d / 2, i - d / 2), r > 0)) {
        const e = Math.min(h / r, _normalizeAngle(s - i));
        t.arc(a, n, r + h / 2, i - e / 2, s + e / 2, !0);
    } else {
        const e = Math.min(h / 2, o * _normalizeAngle(s - i));
        if ("round" === c) t.arc(a, n, e, i - PI / 2, s + PI / 2, !0);
        else if ("bevel" === c) {
            const o = 2 * e * e,
                r = -o * Math.cos(i + PI / 2) + a,
                l = -o * Math.sin(i + PI / 2) + n,
                h = o * Math.cos(s + PI / 2) + a,
                c = o * Math.sin(s + PI / 2) + n;
...
function clipArc(t, e, i) {
    ...
    t.beginPath(),
        t.arc(n, o, r, s - h, i + h),
        l > a
            ? ((h = a / l), t.arc(n, o, l, i + h, s - h, !0))
            : t.arc(n, o, a, i + HALF_PI, s - HALF_PI),
        t.closePath(),
        t.clip();
}
...
function parseBorderRadius$1(t, e, i, s) {
    const a = toRadiusCorners(t.options.borderRadius),
        n = (i - e) / 2,
        o = Math.min(n, (s * e) / 2),
        r = (t) => {
...
function pathArc(t, e, i, s, a, n) {
    const { x: o, y: r, startAngle: l, pixelMargin: h, innerRadius: c } = e,
    ...
    const f = (p - Math.max(0.001, p * d - i / PI) / d) / 2,
        m = l + f + g,
        x = a - f - g,
        {
            outerStart: b,
    ...
    if ((t.beginPath(), n)) {
        ...
        const i = rThetaToXY(A, x, o, r);
        if ((t.lineTo(i.x, i.y), v > 0)) {
            const e = rThetaToXY(A, w, o, r);
            t.arc(e.x, e.y, v, x + HALF_PI, w + Math.PI);
        }
        const s = (x - v / u + (m + y / u)) / 2;
        if (
            (t.arc(o, r, u, x - v / u, s, !0),
            t.arc(o, r, u, s, m + y / u, !0),
            y > 0)
        ) {
        ...
        t.moveTo(o, r);
        const e = Math.cos(D) * d + o,
            i = Math.sin(D) * d + r;
        t.lineTo(e, i);
        const s = Math.cos(M) * d + o,
            a = Math.sin(M) * d + r;
        t.lineTo(s, a);
    }
    t.closePath();
...
function drawBorder(t, e, i, s, a) {
    ...
    p && clipArc(t, e, f),
        l.selfJoin &&
            ...
            "miter" !== c &&
            clipSelf(t, e, f),
        n || (pathArc(t, e, i, s, f, a), t.stroke());
}
class ArcElement extends Element {
    ...
    inRange(t, e, i) {
        const s = this.getProps(["x", "y"], i),
            { angle: a, distance: n } = getAngleFromPoint(s, { x: t, y: e }),
            {
                startAngle: o,
                endAngle: r,
                innerRadius: l,
            ...
            u = valueOrDefault(c, r - o),
            g = _angleBetween(a, o, r) && o !== r,
            p = u >= TAU || g,
            f = _isBetween(n, l + d, h + d);
        return p && f;
    }
    getCenterPoint(t) {
        const {
    ...
    draw(t) {
        ...
        if (
            ...
            (this.fullCircles = i > TAU ? Math.floor(i / TAU) : 0),
        ...
        (t.fillStyle = e.backgroundColor),
            ...
            drawArc(t, this, r, a, n),
            drawBorder(t, this, r, a, n),
            t.restore();
    }
}
function setStyle(t, e, i = e) {
    (t.lineCap = valueOrDefault(i.borderCapStyle, e.borderCapStyle)),
        ...
        (t.lineDashOffset = valueOrDefault(
            i.borderDashOffset,
            e.borderDashOffset
        )),
...
function pathSegment(t, e, i, s) {
    const { points: a, options: n } = e,
        { count: o, start: r, loop: l, ilen: h } = pathVars(a, i, s),
        c = getLineMethod(n);
    let d,
        u,
        g,
    ...
    for (d = 0; d <= h; ++d)
        (u = a[(r + (f ? h - d : d)) % o]),
            u.skip ||
                (p ? (t.moveTo(u.x, u.y), (p = !1)) : c(t, g, u, f, n.stepped),
                (g = u));
    return l && ((u = a[(r + (f ? h : 0)) % o]), c(t, g, u, f, n.stepped)), !!l;
}
function fastPathSegment(t, e, i, s) {
    const a = e.points,
        { count: n, start: o, ilen: r } = pathVars(a, i, s),
...
class LineElement extends Element {
    ...
    updateControlPoints(t, e) {
        ...
        if (
            ...
            _updateBezierControlPoints(this._points, i, t, s, e),
    ...
    interpolate(t, e) {
        const i = this.options,
            s = t[e],
            a = this.points,
            n = _boundSegments(this, { property: e, start: s, end: s });
        if (!n.length) return;
        const o = [],
            r = _getInterpolationMethod(i);
        let l, h;
        for (l = 0, h = n.length; l < h; ++l) {
            const { start: h, end: c } = n[l],
                d = a[h],
                u = a[c];
            if (d === u) {
                o.push(d);
...
function inRange(t, e, i, s) {
    const a = null === e,
        n = null === i,
        o = t && !(a && n) && getBarBounds(t, s);
    return (
        o &&
        (a || _isBetween(e, o.left, o.right)) &&
        (n || _isBetween(i, o.top, o.bottom))
    );
}
...
class BarElement extends Element {
    ...
    draw(t) {
        const {
            ...
            { inner: a, outer: n } = boundingRects(this),
            o = hasRadius(n.radius) ? addRoundedRectPath : addNormalRectPath;
        t.save(),
            (n.w === a.w && n.h === a.h) ||
                (t.beginPath(),
                o(t, inflateRect(n, e, a)),
                t.clip(),
                o(t, inflateRect(a, -e, n)),
                (t.fillStyle = i),
                t.fill("evenodd")),
            t.beginPath(),
            o(t, inflateRect(a, e)),
...
function getColorizer(t) {
    ...
    return (i, s) => {
        ...
        a instanceof DoughnutController
            ? (e = colorizeDoughnutDataset(i, e))
            : a instanceof PolarAreaController
            ? (e = colorizePolarAreaDataset(i, e))
            : a && (e = colorizeDefaultDataset(i, e));
    };
}
...
function containsDefaultColorsDefenitions() {
    return (
        "rgba(0,0,0,0.1)" !== defaults.borderColor ||
    ...
    beforeLayout(t, e, i) {
        ...
        const {
            ...
            o =
                ...
                containsColorsDefinition(a) ||
                (n && containsColorsDefinitions(n)) ||
                containsDefaultColorsDefenitions();
        if (!i.forceOverride && o) return;
        const r = getColorizer(t);
        s.forEach(r);
    },
};
function lttbDecimation(t, e, i, s, a) {
    ...
    for (o[l++] = t[f], c = 0; c < n - 2; c++) {
        ...
        for (u = g = -1, s = b; s < _; s++)
            (g =
                0.5 *
                Math.abs((y - a) * (t[s].y - v) - (y - t[s].x) * (n - v))),
                g > u && ((u = g), (d = t[s]), (p = s));
        (o[l++] = d), (f = p);
    }
    return (o[l++] = t[h]), o;
...
function getStartAndCountOfVisiblePointsSimplified(t, e) {
    ...
    let s,
        a = 0;
    const { iScale: n } = t,
        { min: o, max: r, minDefined: l, maxDefined: h } = n.getUserBounds();
    return (
        l && (a = _limitValue(_lookupByKey(e, n.axis, o).lo, 0, i - 1)),
        (s = h
            ? _limitValue(_lookupByKey(e, n.axis, r).hi + 1, a, i) - a
            : i - a),
        { start: a, count: s }
    );
}
var plugin_decimation = {
    ...
    beforeElementsUpdate: (t, e, i) => {
        ...
        t.data.datasets.forEach((e, a) => {
            ...
            let { start: c, count: d } =
                getStartAndCountOfVisiblePointsSimplified(r, l);
            if (d <= (i.threshold || 4 * s))
                return void cleanDecimatedDataset(e);
            let u;
            switch (
                (isNullOrUndef(n) &&
                    ((e._data = l),
...
function _segments(t, e, i) {
    ...
    for (const t of s) {
        ...
        for (const e of h) {
            const s = _getBounds(i, n[e.start], n[e.end], e.loop),
                r = _boundSegment(t, a, s);
            for (const t of r)
                o.push({
                    source: t,
                    target: e,
...
function _getBounds(t, e, i, s) {
    ...
    let a = e[t],
        n = i[t];
    return (
        "angle" === t && ((a = _normalizeAngle(a)), (n = _normalizeAngle(n))),
    ...
    return (
        e.segments.forEach(({ start: t, end: e }) => {
            ...
            const o = a[t],
                r = a[e];
            null !== s
                ? (n.push({ x: o.x, y: s }), n.push({ x: r.x, y: s }))
                : null !== i &&
                  (n.push({ x: i, y: o.y }), n.push({ x: i, y: r.y }));
        }),
        n
    );
}
...
function _createBoundaryLine(t, e) {
    let i = [],
        s = !1;
    return (
        isArray(t) ? ((s = !0), (i = t)) : (i = _pointsFromSegments(t, e)),
        i.length
            ? new LineElement({
                  points: i,
                  options: { tension: 0 },
...
function addPointsBelow(t, e, i) {
    ...
    for (let a = 0; a < i.length; a++) {
        const n = i[a],
            { first: o, last: r, point: l } = findPoint(n, e, "x");
        if (!(!l || (o && r)))
            if (o) s.unshift(l);
...
function _drawfill(t, e, i) {
    const s = _getTarget(e),
        { chart: a, index: n, line: o, scale: r, axis: l } = e,
        h = o.options,
        c = h.fill,
        d = h.backgroundColor,
        { above: u = d, below: g = d } = c || {},
        p = a.getDatasetMeta(n),
        f = getDatasetClipArea(a, p);
    s &&
        o.points.length &&
        (clipArea(t, i),
        doFill(t, {
    ...
    n !== a &&
        ("x" === h
            ? (clipVertical(t, s, o.top),
              ...
              t.restore(),
              t.save(),
              clipVertical(t, s, o.bottom))
            : "y" === h &&
              (clipHorizontal(t, s, o.left),
              fill(t, {
                  line: i,
                  target: s,
                  color: n,
...
function fill(t, e) {
    const { line: i, target: s, property: a, color: n, scale: o, clip: r } = e,
        l = _segments(i, s, a);
    for (const { source: e, target: h, start: c, end: d } of l) {
        const { style: { backgroundColor: l = n } = {} } = e,
            u = !0 !== s;
        t.save(),
            (t.fillStyle = l),
            clipBounds(t, o, r, u && _getBounds(a, c, d)),
            t.beginPath();
        const g = !!i.pathSegment(t, e);
        let p;
        if (u) {
            g ? t.closePath() : interpolatedLineTo(t, s, d, a);
            const e = !!s.pathSegment(t, h, { move: g, reverse: !0 });
            (p = g && e), p || interpolatedLineTo(t, s, c, a);
        }
        t.closePath(), t.fill(p ? "evenodd" : "nonzero"), t.restore();
    }
}
function clipBounds(t, e, i, s) {
    const a = e.chart.chartArea,
        { property: n, start: o, end: r } = s || {};
    if ("x" === n || "y" === n) {
        let e, s, l, h;
        "x" === n
            ? ((e = o), (s = a.top), (l = r), (h = a.bottom))
            : ((e = a.left), (s = o), (l = a.right), (h = r)),
            t.beginPath(),
            i &&
                ((e = Math.max(e, i.left)),
    ...
    afterDatasetsUpdate(t, e, i) {
        ...
        for (o = 0; o < s; ++o)
            (l = a[o]),
                l &&
                    !1 !== l.fill &&
                    (l.fill = _resolveTarget(a, o, i.propagate));
    },
    beforeDraw(t, e, i) {
...
class Legend extends Element {
    ...
    fit() {
        ...
        const i = t.labels,
            s = toFont(i.font),
            a = s.size,
            n = this._computeTitleHeight(),
            { boxWidth: o, itemHeight: r } = getBoxSize(i, a);
        let l, h;
        (e.font = s.string),
            this.isHorizontal()
                ? ((l = this.maxWidth), (h = this._fitRows(n, a, o, r) + 10))
                : ((h = this.maxHeight), (l = this._fitCols(n, s, o, r) + 10)),
    ...
    _fitCols(t, e, i, s) {
        ...
        return (
            this.legendItems.forEach((t, n) => {
                const { itemWidth: f, itemHeight: m } = calculateItemSize(
                    i,
                    e,
                    a,
                    t,
                ...
                n > 0 &&
                    ...
                    p++,
                    (d = u = 0)),
                    (r[n] = { left: g, top: u, col: p, width: f, height: m }),
                    (d = Math.max(d, f)),
                    (u += m + o);
            }),
            (c += d),
    ...
    adjustHitBoxes() {
        ...
        const t = this._computeTitleHeight(),
            ...
            n = getRtlAdapter(a, this.left, this.width);
        if (this.isHorizontal()) {
            let a = 0,
                o = _alignStartEnd(
                    i,
            ...
            for (const r of e)
                a !== r.row &&
                    ...
                    (r.top += this.top + t + s),
                    (r.left = n.leftForLtr(n.x(o), r.width)),
                    (o += r.width + s);
        } else {
            let a = 0,
                o = _alignStartEnd(
            ...
            for (const r of e)
                r.col !== a &&
                    ...
                    (r.top = o),
                    (r.left += this.left + s),
                    (r.left = n.leftForLtr(n.x(r.left), r.width)),
                    (o += r.height + s);
        }
    }
    isHorizontal() {
    ...
    _draw() {
        const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this,
            { align: a, labels: n } = t,
            o = defaults.color,
            r = getRtlAdapter(t.rtl, this.left, this.width),
            l = toFont(n.font),
            { padding: h } = n,
            c = l.size,
            d = c / 2;
        ...
        this.drawTitle(),
            ...
            (s.lineWidth = 0.5),
            (s.font = l.string);
        const { boxWidth: g, boxHeight: p, itemHeight: f } = getBoxSize(n, c),
            m = this.isHorizontal(),
        ...
        this.legendItems.forEach((_, y) => {
            ...
            const v = s.measureText(_.text).width,
                k = r.textAlign(_.textAlign || (_.textAlign = n.textAlign)),
                S = g + d + v;
            let D = u.x,
                M = u.y;
            ...
            if (
                ((function (t, e, i) {
                    ...
                    if (
                        ((s.fillStyle = valueOrDefault(i.fillStyle, o)),
                        (s.lineCap = valueOrDefault(i.lineCap, "butt")),
                        (s.lineDashOffset = valueOrDefault(
                            i.lineDashOffset,
                            0
                        )),
                        (s.lineJoin = valueOrDefault(i.lineJoin, "miter")),
                        (s.lineWidth = a),
                        (s.strokeStyle = valueOrDefault(i.strokeStyle, o)),
                        s.setLineDash(valueOrDefault(i.lineDash, [])),
                        n.usePointStyle)
                    ) {
                        const o = {
                        ...
                        const n = e + Math.max((c - p) / 2, 0),
                            o = r.leftForLtr(t, g),
                            l = toTRBLCorners(i.borderRadius);
                        s.beginPath(),
                            Object.values(l).some((t) => 0 !== t)
                                ? addRoundedRectPath(s, {
                                      x: o,
                                      y: n,
                                      w: g,
                                      h: p,
                ...
                (D = _textX(k, D + g + d, m ? D + S : this.right, t.rtl)),
                (function (t, e, i) {
                    renderText(s, i.text, t, e + f / 2, l, {
    ...
    drawTitle() {
        const t = this.options,
            e = t.title,
            i = toFont(e.font),
            s = toPadding(e.padding);
        if (!e.display) return;
        const a = getRtlAdapter(t.rtl, this.left, this.width),
            n = this.ctx,
            o = e.position,
            r = i.size / 2,
            l = s.top + r;
        ...
        if (this.isHorizontal())
            (d = Math.max(...this.lineWidths)),
                (h = this.top + l),
                (c = _alignStartEnd(t.align, c, this.right - d));
        else {
        ...
        (n.textAlign = a.textAlign(_toLeftRightCenter(o))),
            (n.textBaseline = "middle"),
            (n.strokeStyle = e.color),
            (n.fillStyle = e.color),
            (n.font = i.string),
            renderText(n, e.text, u, h, i);
    }
    _computeTitleHeight() {
    ...
    _getLegendItemAt(t, e) {
        ...
        if (
            ...
            for (a = this.legendHitBoxes, i = 0; i < a.length; ++i)
                if (
                    ((s = a[i]),
                    _isBetween(t, s.left, s.left + s.width) &&
                        _isBetween(e, s.top, s.top + s.height))
                )
    ...
    handleEvent(t) {
        ...
        if ("mousemove" === t.type || "mouseout" === t.type) {
            const s = this._hoveredItem,
                a = itemsEqual(s, i);
            s && !a && callback(e.onLeave, [t, s, this], this),
                (this._hoveredItem = i),
                i && !a && callback(e.onHover, [t, i, this], this);
...
function calculateItemSize(t, e, i, s, a) {
    return {
        ...
        itemHeight: calculateItemHeight(a, s, e.lineHeight),
    };
}
function calculateItemWidth(t, e, i, s) {
    ...
    return (
        a &&
            "string" != typeof a &&
            (a = a.reduce((t, e) => (t.length > e.length ? t : e))),
        e + i.size / 2 + s.measureText(a).width
    );
}
function calculateItemHeight(t, e, i) {
    let s = t;
    return (
        "string" != typeof e.text && (s = calculateLegendItemHeight(e, i)), s
    );
}
...
class Title extends Element {
    ...
    _drawArgs(t) {
        const { top: e, left: i, bottom: s, right: a, options: n } = this,
            o = n.align;
        let r,
            l,
            h,
        ...
        return (
            this.isHorizontal()
                ? ((l = _alignStartEnd(o, i, a)), (h = e + t), (r = a - i))
                : ("left" === n.position
                      ? ((l = i + t),
                        (h = _alignStartEnd(o, s, e)),
                        (c = -0.5 * PI))
                      : ((l = a - t),
                        (h = _alignStartEnd(o, e, s)),
                        (c = 0.5 * PI)),
                  (r = s - e)),
...
function getTooltipSize(t, e) {
    ...
    return (
        ...
        each(t.title, _),
        (i.font = l.string),
        each(t.beforeBody.concat(t.afterBody), _),
...
function getBackgroundPoint(t, e, i, s) {
    const { caretSize: a, caretPadding: n, cornerRadius: o } = t,
        { xAlign: r, yAlign: l } = i,
        h = a + n,
        {
            topLeft: c,
...
class Tooltip extends Element {
    ...
    getTitle(t, e) {
        ...
        let o = [];
        return (
            (o = pushOrConcat(o, splitNewlines(s))),
        ...
        return (
            each(t, (t) => {
                const e = { before: [], lines: [], after: [] },
                    a = overrideCallbacks(i, t);
                pushOrConcat(
                    e.before,
                    splitNewlines(
                        invokeCallbackWithFallback(a, "beforeLabel", this, t)
                    )
                ),
                    pushOrConcat(
                        e.lines,
                        invokeCallbackWithFallback(a, "label", this, t)
                    ),
                    pushOrConcat(
                        e.after,
                        splitNewlines(
                            invokeCallbackWithFallback(a, "afterLabel", this, t)
                        )
                    ),
                    s.push(e);
            }),
    ...
    _createItems(t) {
        ...
        for (o = 0, r = e.length; o < r; ++o)
            l.push(createTooltipItem(this.chart, e[o]));
        return (
            t.filter && (l = l.filter((e, s, a) => t.filter(e, s, a, i))),
            t.itemSort && (l = l.sort((e, s) => t.itemSort(e, s, i))),
            each(l, (e) => {
                const i = overrideCallbacks(t.callbacks, e);
                s.push(invokeCallbackWithFallback(i, "labelColor", this, e)),
                    a.push(
    ...
    update(t, e) {
        ...
        let a,
            n = [];
        if (s.length) {
            const t = positioners[i.position].call(
                this,
                s,
                this._eventPosition
            );
            ...
            const e = (this._size = getTooltipSize(this, i)),
                o = Object.assign({}, t, e),
                r = determineAlignment(this.chart, i, o),
                l = getBackgroundPoint(i, o, r, this.chart);
    ...
    getCaretPosition(t, e, i) {
        ...
        return (
            "center" === a
                ? ((_ = u + p / 2),
                  "left" === s
                      ? ((f = d), (m = f - n), (b = _ + n), (y = _ - n))
                      : ((f = d + g), (m = f + n), (b = _ - n), (y = _ + n)),
                  (x = f))
                : ((m =
                      "left" === s
                          ? d + Math.max(r, h) + n
                          ...
                          : this.caretX),
                  "top" === a
                      ? ((b = u), (_ = b - n), (f = m - n), (x = m + n))
                      : ((b = u + p), (_ = b + n), (f = m + n), (x = m - n)),
                  (y = b)),
            { x1: f, x2: m, x3: x, y1: b, y2: _, y3: y }
        );
    }
    drawTitle(t, e, i) {
        const s = this.title,
    ...
    _drawColorBox(t, e, i, s, a) {
        ...
        if (a.usePointStyle) {
            ...
            (t.lineWidth = isObject(n.borderWidth)
            ...
            const e = s.leftForLtr(d, l),
                ...
                o = toTRBLCorners(n.borderRadius);
            Object.values(o).some((t) => 0 !== t)
                ? (t.beginPath(),
                  (t.fillStyle = a.multiKeyBackground),
                  addRoundedRectPath(t, { x: e, y: g, w: l, h: r, radius: o }),
                  t.fill(),
                  t.stroke(),
                  (t.fillStyle = n.backgroundColor),
                  t.beginPath(),
    ...
    drawBody(t, e, i) {
        ...
        let d = c.lineHeight,
            u = 0;
        const g = getRtlAdapter(i.rtl, this.x, this.width),
            p = function (i) {
    ...
    _updateAnimationTarget(t) {
        const e = this.chart,
            ...
            a = i && i.y;
        if (s || a) {
            const i = positioners[t.position].call(
                this,
                this._active,
                this._eventPosition
            );
            if (!i) return;
            const n = (this._size = getTooltipSize(this, t)),
                o = Object.assign({}, i, this._size),
                r = determineAlignment(e, t, o),
                l = getBackgroundPoint(t, o, r, e);
            (s._to === l.x && a._to === l.y) ||
                ((this.xAlign = r.xAlign),
                (this.yAlign = r.yAlign),
                (this.width = n.width),
    ...
    _positionChanged(t, e) {
        const { caretX: i, caretY: s, options: a } = this,
            n = positioners[a.position].call(this, t, e);
...
function generateTicks$1(t, e) {
    ...
    (S = Math.ceil(f / D) - Math.floor(p / D)),
        S > g && (D = niceNum((S * D) / g / u) * u),
        isNullOrUndef(r) || ((y = Math.pow(10, r)), (D = Math.ceil(D * y) / y)),
        "ticks" === s
            ? ((v = Math.floor(p / D) * D), (k = Math.ceil(f / D) * D))
            : ((v = p), (k = f)),
        m && x && a && almostWhole((o - n) / a, D / 1e3)
            ? ((S = Math.round(Math.min((o - n) / D, h))),
              (D = (o - n) / S),
              (v = n),
              (k = o))
            : b
            ? ((v = m ? n : v), (k = x ? o : k), (S = l - 1), (D = (k - v) / S))
            : ((S = (k - v) / D),
              (S = almostEquals(S, Math.round(S), D / 1e3)
                  ? Math.round(S)
                  : Math.ceil(S)));
    const M = Math.max(_decimalPlaces(D), _decimalPlaces(v));
    (y = Math.pow(10, isNullOrUndef(r) ? M : r)),
        (v = Math.round(v * y) / y),
        (k = Math.round(k * y) / y);
    let P = 0;
    for (
        ...
        (d && v !== n
            ? (i.push({ value: n }),
              v < n && P++,
              almostEquals(
                  Math.round((v + P * D) * y) / y,
                  n,
                  relativeLabelSize(n, _, t)
              ) && P++)
            : v < n && P++);
        P < S;
        ++P
    ...
    return (
        x && d && k !== o
            ? i.length &&
              almostEquals(i[i.length - 1].value, o, relativeLabelSize(o, _, t))
                ? (i[i.length - 1].value = o)
                : i.push({ value: o })
            : (x && k !== o) || i.push({ value: k }),
        i
    );
}
function relativeLabelSize(t, e, { horizontal: i, minRotation: s }) {
    const a = toRadians(s),
        n = (i ? Math.sin(a) : Math.cos(a)) || 0.001,
        o = 0.75 * e * ("" + t).length;
...
class LinearScaleBase extends Scale {
    ...
    buildTicks() {
        ...
        return (
            "ticks" === t.bounds && _setMinAndMaxByKey(s, this, "value"),
            t.reverse
...
function generateTicks(t, { min: e, max: i }) {
    ...
    let d = Math.floor((h - c) / Math.pow(10, n)),
        u = finiteOrDefault(
            t.min,
            Math.round((l + c + d * Math.pow(10, n)) * o) / o
        );
    for (; u < i; )
        s.push({ value: u, major: isMajor(u), significand: d }),
            d >= 10 ? (d = d < 15 ? 15 : 20) : d++,
            d >= 20 && (n++, (d = 2), (o = n >= 0 ? 1 : o)),
...
class LogarithmicScale extends Scale {
    ...
    handleTickRangeOptions() {
        ...
        i === s &&
            (i <= 0
                ? (a(1), n(10))
                : (a(changeExponent(i, -1)), n(changeExponent(s, 1)))),
            i <= 0 && a(changeExponent(s, -1)),
            s <= 0 && n(changeExponent(i, 1)),
            (this.min = i),
            (this.max = s);
    }
    buildTicks() {
        ...
        return (
            ...
            null === t || isNaN(t)
                ...
                : this.getPixelForDecimal(
                      t === this.min
                          ? 0
                          : (log10(t) - this._startValue) / this._valueRange
                  )
        );
    }
    getValueForPixel(t) {
...
function fitWithPointLabels(t) {
    ...
    for (let l = 0; l < n; l++) {
        ...
        a[l] = n.padding;
        const h = t.getPointPosition(l, t.drawingArea + a[l], r),
            c = toFont(n.font),
            d = measureLabelSize(t.ctx, c, t._pointLabels[l]);
        s[l] = d;
        const u = _normalizeAngle(t.getIndexAngle(l) + r),
            g = Math.round(toDegrees(u));
        updateLimits(
            i,
            e,
            u,
            determineLimits(g, h.x, d.w, 0, 180),
            determineLimits(g, h.y, d.h, 90, 270)
        );
    }
    t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
        (t._pointLabelItems = buildPointLabelItems(t, s, a));
}
function updateLimits(t, e, i, s, a) {
    const n = Math.abs(Math.sin(i)),
        o = Math.abs(Math.cos(i));
    let r = 0,
        l = 0;
    s.start < e.l
        ? ((r = (e.l - s.start) / n), (t.l = Math.min(t.l, e.l - r)))
        : s.end > e.r &&
          ((r = (s.end - e.r) / n), (t.r = Math.max(t.r, e.r + r))),
        a.start < e.t
...
function createPointLabelItem(t, e, i) {
    const s = t.drawingArea,
        ...
        h = Math.round(toDegrees(_normalizeAngle(l.angle + HALF_PI))),
        c = yForAngle(l.y, r.h, h),
        d = getTextAlignForAngle(h),
        u = leftForTextAlign(l.x, r.w, d);
    return {
        visible: !0,
        x: l.x,
        y: c,
...
function isNotOverlapped(t, e) {
    ...
    return !(
        _isPointInArea({ x: i, y: s }, e) ||
        _isPointInArea({ x: i, y: n }, e) ||
        _isPointInArea({ x: a, y: s }, e) ||
        _isPointInArea({ x: a, y: n }, e)
    );
}
function buildPointLabelItems(t, e, i) {
    const s = [],
        ...
        n = t.options,
        { centerPointLabels: o, display: r } = n.pointLabels,
        l = {
            extra: getTickBackdropHeight(n) / 2,
            additionalAngle: o ? PI / a : 0,
        };
    let h;
    for (let n = 0; n < a; n++) {
        ...
        s.push(a),
            "auto" === r &&
                ((a.visible = isNotOverlapped(a, h)), a.visible && (h = a));
    }
    return s;
}
...
function drawPointLabelBox(t, e, i) {
    const { left: s, top: a, right: n, bottom: o } = i,
        { backdropColor: r } = e;
    if (!isNullOrUndef(r)) {
        const i = toTRBLCorners(e.borderRadius),
            l = toPadding(e.backdropPadding);
        t.fillStyle = r;
        const h = s - l.left,
            c = a - l.top,
            d = n - s + l.width,
        ...
        Object.values(i).some((t) => 0 !== t)
            ? (t.beginPath(),
              addRoundedRectPath(t, { x: h, y: c, w: d, h: u, radius: i }),
              t.fill())
            : t.fillRect(h, c, d, u);
    }
}
...
function pathRadiusLine(t, e, i, s) {
    const { ctx: a } = t;
    if (i) a.arc(t.xCenter, t.yCenter, e, 0, TAU);
    else {
...
class RadialLinearScale extends LinearScaleBase {
    ...
    setDimensions() {
        const t = (this._padding = toPadding(
    ...
    getIndexAngle(t) {
        const e = TAU / (this._pointLabels.length || 1),
    ...
    drawGrid() {
        const t = this.ctx,
            e = this.options,
            { angleLines: i, grid: s, border: a } = e,
    ...
    drawLabels() {
        ...
        t.save(),
            ...
            this.ticks.forEach((s, o) => {
                ...
                const r = i.setContext(this.getContext(o)),
                    l = toFont(r.font);
                if (
...
function parse(t, e) {
    ...
    return (
        ...
        isNumberFinite(o) ||
            (o = "string" == typeof s ? i.parse(o, s) : i.parse(o)),
        null === o
            ? null
            : (a &&
                  (o =
                      "week" !== a || (!isNumber(n) && !0 !== n)
                          ? i.startOf(o, a)
...
function setMajorTicks(t, e, i, s) {
    const a = t._adapter,
        n = +a.startOf(e[0].value, s),
        o = e[e.length - 1].value;
    let r, l;
    for (r = n; r <= o; r = +a.add(r, 1, s))
...
function ticksFromTimestamps(t, e, i) {
    ...
    let o, r;
    for (o = 0; o < n; ++o)
        (r = e[o]), (a[r] = o), s.push({ value: r, major: !1 });
...
class TimeScale extends Scale {
    ...
    init(t, e = {}) {
        const i = t.time || (t.time = {}),
            s = (this._adapter = new adapters._date(t.adapters.date));
        s.init(e),
            mergeIf(i.displayFormats, s.formats()),
            (this._parseOpts = {
                parser: i.parser,
                round: i.round,
    ...
    determineDataLimits() {
        ...
        (n && o) ||
            ...
            ("ticks" === t.bounds && "labels" === t.ticks.source) ||
                r(this.getMinMax(!1))),
            (s =
                isNumberFinite(s) && !isNaN(s) ? s : +e.startOf(Date.now(), i)),
            (a =
                isNumberFinite(a) && !isNaN(a)
                    ? a
    ...
    _generate() {
        const t = this._adapter,
            ...
            n =
                ...
                determineUnitForAutoTicks(
                    ...
                    e,
                    i,
                    this._getLabelCapacity(e)
                ),
            o = valueOrDefault(s.ticks.stepSize, 1),
        ...
        return (
            (c !== i && "ticks" !== s.bounds && 1 !== d) || addTick(h, c, g),
            Object.keys(h)
                .sort(sorter)
                .map((t) => +t)
        );
    ...
    _getLabelSize(t) {
        const e = this.options.ticks,
            ...
            s = toRadians(this.isHorizontal() ? e.maxRotation : e.minRotation),
            a = Math.cos(s),
            n = Math.sin(s),
...
function interpolate(t, e, i) {
    ...
    i
        ? (e >= t[r].pos &&
              e <= t[l].pos &&
              ({ lo: r, hi: l } = _lookupByKey(t, "pos", e)),
          ({ pos: s, time: n } = t[r]),
          ({ pos: a, time: o } = t[l]))
        : (e >= t[r].time &&
              e <= t[l].time &&
              ({ lo: r, hi: l } = _lookupByKey(t, "time", e)),
          ({ time: s, pos: n } = t[r]),
          ({ time: a, pos: o } = t[l]));
    const h = a - s;
